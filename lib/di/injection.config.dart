...
import 'package:treechan/data/rest/rest_client.dart' as _i10;
...
import 'package:treechan/domain/services/media_download_service.dart' as _i9;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i9.MediaDownloadService>(() => _i9.MediaDownloadService());
  gh.factoryParam<_i10.RestClient, _i11.Dio, dynamic>(
    (
      dio,
      _,
    ) =>
        _i10.DvachRestClient(dio),
    instanceName: 'dvach',
    registerFor: {
      _test,
      _dev,
  ...
  gh.factoryParam<_i10.RestClient, _i11.Dio, dynamic>(
    (
      ...
      _,
        ...
        _i10.DvachArchiveRestClient(dio),
